<!-- start footer Area -->		
			...
			<script src="<?php echo base_url()?>aset/js/vendor/jquery-2.2.4.min.js"></script>
			<script src="<?php echo base_url()?>aset/https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>
			...
			<script src="<?php echo base_url()?>aset/js/slick.js"></script>
